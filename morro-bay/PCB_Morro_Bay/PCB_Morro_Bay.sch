...
F 1 "USB_B" H 957 1726 50  0000 C CNN
...
U 1 1 5E392D8B
P 1400 1350
F 0 "C3" H 1515 1396 50  0000 L CNN
F 1 "0.1uF" H 1515 1305 50  0000 L CNN
...
U 1 1 5E3943A9
P 1900 1350
F 0 "C4" H 2015 1396 50  0000 L CNN
...
U 1 1 5E394B09
P 2400 1350
F 0 "C5" H 2515 1396 50  0000 L CNN
F 1 "10uF" H 2515 1305 50  0000 L CNN
...
U 1 1 5E3C6B76
P 3650 1250
F 0 "U3" H 3650 1617 50  0000 C CNN
F 1 "MIC5504-3.3YM5" H 3650 1526 50  0000 C CNN
F 2 "Package_TO_SOT_SMD:SOT-23-5" H 3650 850 50  0001 C CNN
F 3 "http://ww1.microchip.com/downloads/en/DeviceDoc/MIC550X.pdf" H 3400 1500 50  0001 C CNN
	1    3650 1250
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5E3CC04E
P 3650 1600
F 0 "#PWR015" H 3650 1350 50  0001 C CNN
...
F 1 "1uF" H 3015 1305 50  0000 L CNN
...
U 1 1 5E3CF188
P 4100 1350
F 0 "C8" H 4215 1396 50  0000 L CNN
F 1 "1uF" H 4215 1305 50  0000 L CNN
...
U 1 1 5E3D082D
P 4100 1600
F 0 "#PWR018" H 4100 1350 50  0001 C CNN
...
TODO:\n-CRYSTALS\n-CAN CONTROLS\n-LEDS\n-CHECK INPUT CURRENT ON ADC PINS\n-EXTERNAL ADC\n-SERIAL
Text Notes 500  2250 0    50   ~ 0
Should this be a USB plug? I like it,\nbut could also make it a Microfit.
$EndSCHEMATC
